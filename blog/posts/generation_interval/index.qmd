...
Wallinga and Lipsitch [@wallinga2007] wrote a highly cited paper about the reproduction number. It discusses how to derive reproduction number, $R$, given the growth rate, $r$, and the generation interval, $T_c$.
