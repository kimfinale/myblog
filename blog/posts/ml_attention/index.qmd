...
```{r}
#| label: attn-plot
#| fig-cap: "Left: one-step-ahead forecasts. Attention (blue) tracks the epidemic curve more closely than the moving average (orange) by learning non-uniform lag weights. Right: learned attention weights. Lags 2 and 4 (the even lags, in-phase with the 2-week cycle) receive all the weight; lags 1, 3, and 5 (out-of-phase) receive zero. A fixed moving average wastes weight on the out-of-phase lags and is therefore a worse predictor."
#| fig-width: 10
#| fig-height: 4
