...
```{r}
#| label: attn-plot
#| fig-cap: "Left: one-step-ahead forecasts. Attention (blue) tracks the epidemic curve more closely than the moving average (orange) because it concentrates weight on the most recent lag. Right: learned attention weights by lag. Lag 1 (last week) receives nearly all the weight — consistent with strong short-term autocorrelation in epidemic incidence."
#| fig-width: 10
#| fig-height: 4
