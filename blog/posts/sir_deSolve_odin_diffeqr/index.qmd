...
This post benchmarks three approaches to solving ODE-based SIR models: the `deSolve` package [@soetaert2010] in R, the `odin` package [@fitzjohn2021] (which compiles R code to C), and `diffeqr` which calls Julia's DifferentialEquations.jl.
