...
This post extends the right-truncation approach from the previous post (see Seaman et al. [@seaman2022]) by implementing the likelihood in Stan [@carpenter2017], a probabilistic programming language for Bayesian inference.
