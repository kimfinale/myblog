...
In the branching process model, the number of secondary infections is realized as a random number (e.g., Poisson or negative binomial) [@harris1963]. Individual variation in transmission can be modelled via a negative binomial offspring distribution, which captures superspreading dynamics [@lloyd-smith2005].
