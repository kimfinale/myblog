...
In this post, I compared the numerical solutions obtained using `deSolve::ode` with the algebraic solutions derived from Mathematica for the steady states of a SEIR model [@hethcote2000; @keeling2008]. The model considers the waning of natural immunity over time in a dynamically changing population.
