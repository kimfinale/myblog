...
Particle filters, also known as sequential Monte Carlo (SMC) methods, provide a general framework for Bayesian filtering in nonlinear, non-Gaussian state space models [@gordon1993; @kitagawa1996; @doucet2009]. The following example was adapted from the post in [RPubs](https://rpubs.com/awellis/180442).
