...
When estimating serial intervals or other time-to-event distributions from epidemic data, right truncation is a key consideration: individuals are observed only if their event time falls before some truncation time [@seaman2022]. The corrected likelihood accounts for this selection mechanism.
