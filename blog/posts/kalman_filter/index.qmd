...
The Kalman filter [@kalman1960] is a recursive algorithm for estimating the state of a linear dynamical system from noisy observations. Arroyo-Marioli _et al_. [@arroyo2021] applied a Kalman filter approach to estimate the effective reproduction number $R$ of COVID-19. I tried to reproduce their approach in R. Let's use a SIR model as was used in my [previous post](https://www.jonghoonk.com/blog/posts/sir_deSolve_odin_diffeqr/) to generate growth rate time series.
