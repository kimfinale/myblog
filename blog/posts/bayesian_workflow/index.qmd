...
Let's suppose that we measured how the number of contact a person makes varies. A prior study [@mossong2008] and other numerous studies showed that contact frequencies differ by age. And a significant fraction of contacts occur with household members and as such the contact frequencies will likely vary by household size. We sampled a group of people and followed them for some time (e.g., 1 week) and measured the number of contacts that a typical person makes in a day. We also collected variables such as age, sex, and household size.
...
We use leave-one-out (LOO) cross validation as suggested in Vehtari _et al_. [@vehtari2017] and Gelman _et al_. [@gelman2020].
