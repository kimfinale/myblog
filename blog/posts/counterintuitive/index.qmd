...
An article by Heesterbeek et al. [@heesterbeek2015] provides a few examples on the counterintuitive behavior of a dynamical system of disease transmission. The first example was about the relationship between the intensity of transmission and the prevalence of infection, citing the work by Anderson and Medley [@anderson1985]. One message from the study by Anderson and Medley is that the effect of intervention should not be measured by the prevalence of infection. A similar message can be drawn from a simple relationship between $R_0$ and the prevalence of infection. As shown in the figure below, reducing $R_0$ from 15 to 10 may require a lot of efforts and its effect on prevalence of infection may be small.
