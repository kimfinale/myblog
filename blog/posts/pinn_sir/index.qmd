...
The PINN fits the observed $I(t)$ points and simultaneouly reconstructs the latent
$S(t)$ and $R(t)$ trajectories. The physics
...
The loss weight $\lambda_\phi$ trades off data fidelity and physics constraint
