...
† Interestingly, the [Wikipedia article on serial interval](https://en.wikipedia.org/wiki/Serial_interval) says that the length of a serial interval is equal to the sum of incubation period and the half of the infectious period.
