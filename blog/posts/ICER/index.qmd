...
DALYs are the sum of years of life lost (YLLs) and years of life lived with disability (YLDs). [@foxrushby2001] presents a somewhat involved equation for DALYs, originally developed for the Global Burden of Disease study [@worldbank1993].

A simpler version, which appears to be widely adopted, uses uniform weighting across age groups and is explained by [@larson2013].
