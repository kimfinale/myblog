...
1. Ridge (L2) — introduced by Hoerl and Kennard [@hoerl1970]
2. Lasso (L1) — introduced by Tibshirani [@tibshirani1996]
3. Elastic Net (combination of L1 and L2) — introduced by Zou and Hastie [@zou2005]
