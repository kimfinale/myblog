...
In his lecture, Joseph Blitzstein talks about two basic statistical phenomena: Regression toward to the mean (RTTM) and survivor bias (or conditioning more broadly). The RTTM is today's topic. Barnett et al. [@barnett2005] provide a comprehensive review of this phenomenon and its implications in epidemiology.
...
Full details of Kahneman's quote and the statistical context of regression to the mean are discussed by Barnett et al. [@barnett2005].
